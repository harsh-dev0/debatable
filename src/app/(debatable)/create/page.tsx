    ...
    const { mutate: createCommunity, isLoading } = useMutation({
        ...
        onError: (err) => {
            if (err instanceof AxiosError) {
                if (err.response?.status === 409) {
                    return toast({
                        ...
                        description: 'Oh! No! A debatable group already exists with that name. Try a differnt name',
                        variant: 'destructive'
                    })
                }
            ...
            toast({
                ...
                description: 'Sorry!! We could not create a debatable group, please try again later.',
                variant: 'destructive'
            })
        },
        onSuccess: (data) =>{
